...
function ExportFirewall-To-Blob-Storage([string]$resourceGroupName, [string]$AzureFirewallName, [string]$storageKey, [string]$blobContainerName,$storageContext) {
...
ExportFirewall-To-Blob-Storage `
...
ExportFirewallPolicy-To-Blob-Storage `
	-resourceGroupName $ResourceGroupName `
	-AzureFirewallName $AzureFirewallName `
	-storageKey $StorageKey `
	-blobContainerName $BlobContainerName `
